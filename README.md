...
<html>
 <table>
  <tr>
   <td>![Take off](https://drone-steering.azurewebsites.net/images/gesture_take_off.png)</td>
   <![Left](https://drone-steering.azurewebsites.net/images/gesture_left.png)</td>
  </tr>
  <tr>
   <td>![Land](https://drone-steering.azurewebsites.net/images/gesture_land.png)</td>
   <td>![Right](https://drone-steering.azurewebsites.net/images/gesture_right.png)</td>
  </tr>
  <tr>
   <td>![Move](https://drone-steering.azurewebsites.net/images/gesture_move.png)</td>
   <td>![Looping](https://drone-steering.azurewebsites.net/images/gesture_looping.png)</td>
  </tr>
 </table>
</html>  
