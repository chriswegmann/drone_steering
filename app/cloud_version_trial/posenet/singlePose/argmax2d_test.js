...
describe('argmax2d', function () {
    ...
    it('x = [3, 3, 1]', function () {
        ...
        tf.test_util.expectArraysClose(argmax2d_1.argmax2d(input1), tf.tensor2d([2, 1], [1, 2], 'int32'));
        tf.test_util.expectArraysClose(argmax2d_1.argmax2d(input2), tf.tensor2d([1, 0], [1, 2], 'int32'));
    });
    it('x = [3, 3, 3]', function () {
        var input1 = tf.tensor3d([1, 2, 0, 3, 4, -1, 2, 9, 6], [3, 3, 1]);
